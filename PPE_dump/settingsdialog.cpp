...
void SettingsDialog::showPortInfo(int idx)
{
    ...
    m_ui->manufacturerLabel->setText(tr("Fabriquant: %1").arg(list.count() > 2 ? list.at(2) : tr(blankString)));
    m_ui->serialNumberLabel->setText(tr("Numéro de série: %1").arg(list.count() > 3 ? list.at(3) : tr(blankString)));
    m_ui->locationLabel->setText(tr("Emplacement: %1").arg(list.count() > 4 ? list.at(4) : tr(blankString)));
    m_ui->vidLabel->setText(tr("Identifiant du vendeur: %1").arg(list.count() > 5 ? list.at(5) : tr(blankString)));
    m_ui->pidLabel->setText(tr("Identifiant du produit: %1").arg(list.count() > 6 ? list.at(6) : tr(blankString)));
}
...
void SettingsDialog::fillPortsParameters()
{
    ...
    m_ui->baudRateBox->addItem(tr("Personnalisée"));
    ...
    m_ui->parityBox->addItem(tr("Aucun"), QSerialPort::NoParity);
    ...
    m_ui->flowControlBox->addItem(tr("Aucun"), QSerialPort::NoFlowControl);
...
void SettingsDialog::fillPortsInfo()
{
    ...
    m_ui->serialPortInfoListBox->addItem(tr("Personnalisé"));
}
